 ...
 * <p>
 * Implementations of this interface are generated by ByteBuddy with direct field access.
 * Eliminates MethodHandle.invoke() overhead during entity save operations.
 *
...
public interface EntitySaver<T> {
     ...
     */
    T save(T entity, io.memris.storage.GeneratedTable table, Long id);
