...
public final class RepositoryEmitter {
    ...
    public static <T, R extends MemrisRepository<T>> R createRepository(Class<R> repositoryInterface,
        ...
        io.memris.core.EntityMetadata<T> metadata = 
            io.memris.core.MetadataExtractor.extractEntityMetadata(entityClass);
        ...
        io.memris.query.CompiledQuery[] compiledQueries = 
            new io.memris.query.CompiledQuery[methods.length];
        
        io.memris.query.QueryCompiler compiler = new io.memris.query.QueryCompiler(metadata);
        
        for (int i = 0; i < methods.length; i++) {
            java.lang.reflect.Method method = methods[i];
            io.memris.query.LogicalQuery logicalQuery = io.memris.query.QueryPlanner.parse(method, entityClass, metadata.idColumnName());
        ...
        io.memris.runtime.RepositoryPlan<T> plan = 
            io.memris.runtime.RepositoryPlan.fromGeneratedTable(
                table,
                entityClass,
        ...
        io.memris.runtime.RepositoryRuntime<T> runtime = 
                new io.memris.runtime.RepositoryRuntime<>(plan, null, metadata);
    ...
    private static <T> io.memris.query.CompiledQuery[] wireJoinRuntime(
        ...
        for (int i = 0; i < compiledQueries.length; i++) {
            ...
            for (int j = 0; j < joins.length; j++) {
                ...
                io.memris.runtime.JoinExecutor executor = new io.memris.runtime.JoinExecutorImpl(
                ...
                io.memris.runtime.JoinMaterializer materializer = new io.memris.runtime.JoinMaterializerImpl(
                    join.sourceColumnIndex(),
                    join.targetColumnIndex(),
                    join.targetColumnIsId(),
                    join.fkTypeCode(),
