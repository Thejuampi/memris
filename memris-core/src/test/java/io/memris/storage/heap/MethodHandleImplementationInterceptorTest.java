...
class MethodHandleImplementationInterceptorTest {
    // Ownership: interceptor operation branching (lookup/remove/unknown, scan/read/present/isLive and typed insert edges).
    // Out-of-scope: generated bytecode table structure/direct accessor guarantees (owned by BytecodeTableGeneratorTest).
