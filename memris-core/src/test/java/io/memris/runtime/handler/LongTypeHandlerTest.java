...
class LongTypeHandlerTest {
    // Ownership: long-specific executeCondition/null routing checks.
    // Out-of-scope: full long equals/between/in and conversion matrix (owned by IntAndLongTypeHandlerTest).

    @Test
    void shouldRouteComparisonAndNullOperators() {
